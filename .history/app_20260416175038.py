  ...
  <body>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        ...
        feedback.className = 'js-feedback';
        ...
        function updateButtonState() {
          const aValid = validateNumber(form.elements.a.value);
          const bValid = validateNumber(form.elements.b.value);
          const showError = !(aValid && bValid);

          feedback.textContent = showError ? 'Please enter valid numeric values for both fields.' : '';
          feedback.style.display = showError ? 'block' : 'none';
          submitButton.disabled = showError;
        }
